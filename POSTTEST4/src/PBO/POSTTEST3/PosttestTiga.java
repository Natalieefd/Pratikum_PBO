...
public class PosttestTiga {
        ...
        // add data pemenang
            ...
            if (peserta.size() == 0){
                ...
                try {
                    ...
                    if (cekData(2, indexPeserta) == 1){
                    } else if (cekData(2, indexPeserta) == 2) {
        ...
        //add data finalis
            ...
            if (peserta.size() == 0){
                ...
                try {
                    ...
                    if (cekData(3, indexPeserta) == 1){
                    } else if (cekData(3, indexPeserta) == 2){
                        int nomorPeserta = peserta.get(indexPeserta-1).getNomorPeserta();
                        String nama = peserta.get(indexPeserta-1).getNama();
                        int angkatan = peserta.get(indexPeserta-1).getAngkatan();
                        int kelas = peserta.get(indexPeserta-1).getKelas();
    ...
    public static int cekData(int pilihan, int indexPeserta) throws IOException{
        //cek data pemenang
        if (pilihan == 2){
            if (pemenang.size() > 0){
